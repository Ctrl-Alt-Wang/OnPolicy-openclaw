...
CONTAINER_COUNT = 10
CONTAINER_PREFIX = "hermes-science"
IMAGE = "nanobot-hermes-agent:latest"
NETWORK = "openclaw-internal"
INTERNAL_PORT = 18080
AGENT_PROFILE = "science"
AGENT_DIR = os.path.join(PROJECT_DIR, "deploy_copy", "Agents", "science")
...
ENV = _load_env()
DEFAULT_MODEL = ENV.get("SCIENCE_MODEL", "openai/gpt-5.4")
...
def main():
    parser = argparse.ArgumentParser(description="管理科研智能体的 Hermes 容器")
