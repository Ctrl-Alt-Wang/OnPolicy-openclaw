...
DEFAULT_URL = "http://localhost:8080/api/model/chat"
...
def main():
    parser = argparse.ArgumentParser(description="测试 /api/model/chat reasoningMessage 转发")
    parser.add_argument("--url", default=DEFAULT_URL, help="API 地址，默认 http://localhost:8080/api/model/chat")
